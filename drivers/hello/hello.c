...
LOCAL RETURN int hello_init(void);
LOCAL RETURN void hello_exit(void);
...
output param     : NONE
**********************************************************************************************/
LOCAL int __init hello_init(void) {
...
output param     : NONE
**********************************************************************************************/
LOCAL void __exit hello_exit(void) {
